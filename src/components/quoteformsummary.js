...
export default function QuoteFormSummary() {
  ...
  const handlePlanSelect = (plan) => {
    ...
    // Mark plan as selected and show the summary
    setPlanSelected(true);
    setQuoteSaved(true); // Ensure the summary is displayed
  ...
  const handleChangeSelection = () => {
    console.log('Changing selection, resetting planSelected state');
